                <tr data-id="<?php echo $v['id']; ?>" class="<?php if($v['disable']) echo 'disable'; ?>">
                    ...
                    <td class="hidden-xs">
                        <a href="http://www.amazon.co.jp/dp/<?php echo $v['code']; ?>" target="_blank"><?php echo $v['title'] ?></a><br />
                        <?php if($v['star']){ ?>
                        <label class="label label-warning" title="<?php echo $v['star']; ?>">
                            <?php for($i=1; $i<=floor($v['star']); $i++) { ?>
                            <span class="glyphicon glyphicon-star"></span>
                            <?php } ?>
                            <?php if ($v['star']*10%10 >= 5) { ?>
